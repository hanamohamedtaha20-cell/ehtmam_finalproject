...
class BundlesView extends StatelessWidget {
  ...
  void _showEditBundleDialog(
    ...
    TextEditingController(text: bundle['sessions'].toString());
    final validityController =
    TextEditingController(text: bundle['days'].toString());
    final priceController =
    TextEditingController(text: bundle['price'].toString());
    final discountController =
    TextEditingController(text: bundle['discount'].toString());

    List<String> features = List<String>.from(bundle['features'] ?? []);
